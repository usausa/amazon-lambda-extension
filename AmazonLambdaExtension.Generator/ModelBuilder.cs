...
public static class ModelBuilder
{
    ...
    public static FunctionModel BuildFunctionInfo(ITypeSymbol symbol)
    {
        ...
        return new FunctionModel(
            ...
            serviceResolver is not null && ResolveNamedArgument(serviceResolver, "ResolveFunction", false));
    }
    ...
    private static ParameterModel BuildParameterInfo(IParameterSymbol symbol)
    {
        foreach (var attribute in symbol.GetAttributes())
        {
            ...
            if (attributeName == FromBodyAttributeName)
            {
                ...
                return new ParameterModel(symbol.Name, BuildTypeInfo(symbol.Type), ParameterType.FromBody, ResolveNamedArgument(attribute, "SkipValidate", false));
            }
